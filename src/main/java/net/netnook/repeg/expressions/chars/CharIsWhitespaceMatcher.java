...
final class CharIsWhitespaceMatcher extends CharMatcher {
	...
	static final CharIsWhitespaceMatcher INSTANCE = new CharIsWhitespaceMatcher();

	private CharIsWhitespaceMatcher() {
